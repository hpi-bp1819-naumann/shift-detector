...
from shift_detector.checks.frequent_item_rules import fp_growth, rule_compression
...
class FrequentItemsetCheck(Check):
    ...
    def run(self, store: Store) -> FrequentItemsetReport:
        ...
        item_rules = fp_growth.calculate_frequent_rules(df1, df2, self.min_support,
                                                        self.min_confidence)
