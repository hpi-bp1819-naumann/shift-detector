...
def generate_association_rules(patterns, confidence_threshold, size):
    """
    Given a set of frequent itemsets, return a dict
    of association rules in the form
    {(left, right): (support_of_left_side, support, confidence)}
    """
            ...
            for antecedent in itertools.combinations(itemset, i):
                ...
                if antecedent in patterns:
                    ...
                    if confidence >= confidence_threshold:
                        data = Data(antecedent, consequent)
                        meta_data = MetaData(lower_support / size, upper_support / size, confidence)
