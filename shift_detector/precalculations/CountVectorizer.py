...
class CountVectorizer(Precalculation):
    ...
    def process(self, store):
        train_texts, test_texts = store[ColumnType.text]  # I need Series here
        ...
        vectorized_train = self.vectorizer.transform(train_texts)
        vectorized_test = self.vectorizer.transform(test_texts)
