...
class TestSimpleCheck(unittest.TestCase):
    ...
    def test_run_with_empty_dataframes(self):
        ...
        self.assertEqual({'categorical_comparison': {}, 'numerical_comparison': {}}, self.check.run(empty_store))

    def test_minmax_metrics(self):
        comparison_numeric = self.check.run(self.store_numerical)['numerical_comparison']
    ...
    def test_quartile_metrics(self):
        ...
        comparison_numeric = self.check.run(new_numerical_store)['numerical_comparison']
    ...
    def test_categorical_values(self):
        comparison_categorical = self.check.run(self.store_categorical)['categorical_comparison']
